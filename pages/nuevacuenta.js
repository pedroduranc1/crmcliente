    ...
    const formik = useFormik({
        ...
        onSubmit: async valores =>{
            ...
            try {
                ...
                guardarMensaje("El usuario ya esta registrado")
                setTimeout(() => {
                    guardarMensaje(null)
                },3000);
            }
        ...
        <Layout>
            ...
            <div className="flex justify-center mt-5">
                <div className="w-full max-w-sm">
                    <form className="bg-white rounded shadow-md px-8 pt-6 
                    pb-8 mb-4"
                    ...
                    >
...

                        {
                            ...
                            ? 
                            (<div className="my-2 bg-red-100 border-l-4 border-red-500 
                            text-red-700 p-4">
                        ...
                        <Link href="/login">
                            <a
                            className="bg-gray-800 w-full inline-block text-center mt-5 p-2 text-white uppercase
                            hover:bg-gray-700"
                            >volver a login</a>
                        </Link>
                    </form>
