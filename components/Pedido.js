...
const Pedido = ({pedido}) => {
    ...
    return ( 
        <div className={`${clase} border-t-4 mt-4 bg-white rounded p-6 md:grid md:grid-cols-2 md:grid-gap-4 shadow-lg`}>
            <div>
                ...
                <select
                 className="mt-2 appearance-none bg-blue-600 border border-blue-600
                            ...
                            focus:outline-none focus:bg-blue-600 focus:border-blue-500
            ...
            <div>
                ...
                <button
                    ...
                    inline-block text-white rounded leading-tight
                    uppercase text-xs
                    "
